...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['edit'])) {
        ...
        $name = urlencode($_SESSION['user_info']['name']);
        $education = urlencode($_SESSION['user_info']['education']);
        $profession = urlencode($_SESSION['user_info']['profession']);
        header("Location: info.php?name=$name&education=$education&profession=$profession");
        exit();
    }
